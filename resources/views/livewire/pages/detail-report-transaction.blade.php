            ...
            <div class="col-md-12" id="table-daily">
                <div class="col-md-12">
                    <table class="table">
                        ...
                        <tr style="vertical-align: middle;text-align: center;" colspan="10">
                            <td style="vertical-align: middle;text-align: center;" colspan="10"> Laporan Tanggal {{$startDate}} </td>
                        </tr>
                        <tr style="vertical-align: middle;text-align: center;" colspan="10">
                            <td style="vertical-align: middle;text-align: center;" colspan="10"> Tanggal Cetak {{$currentData}} </td>
                        </tr>
...
{{--                                    <td style="text-align: center"> {{$item['total_amount']}} </td>--}}
                            ...
                            <tr class="total">
                                ...
                                @else
                                    ...
                                    <th style="vertical-align: middle;text-align: center;" colspan="2"> Rp. {{number_format(collect($data)->sum('amount'))}} </th>
                                @endif
